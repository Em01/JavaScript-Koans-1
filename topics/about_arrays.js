...
test("splice", function() {
    ...
    var workingWeek = daysOfWeek.splice(0, 2);
    ok(workingWeek.equalTo(['Monday', 'Tuesday']), 'what is the value of workingWeek?');
    ok(daysOfWeek.equalTo(['Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday']), 'what is the value of daysOfWeek?');
});
